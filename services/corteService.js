...
const getCorteDiaSucursal = async(corteData) => {
    ...
    const desgloseFormaPago = await cortesDao.getDesgloseFormaPago({ idSucursal: parseInt(idSucursal), fechaInicio: fechaInicio, fechaFin: fechaFin });
    ...
    return {
        ...
        totalCaja: totalCaja,
        desgloseFormaPago:desgloseFormaPago
    };
};
